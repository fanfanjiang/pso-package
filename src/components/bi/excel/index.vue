      ...
      <template v-if="curNode && !initializing">
        <div class="pso-view-header">
          ...
          <div class="pso-view-header__r">
            ...
            <el-button size="mini" type="primary" @click="saveConfig">发布</el-button>
          </div>
        </div>
        ...
        <div class="pso-view-table" v-loading="saving">
          <template v-if="!!curNode.is_leaf">
            <div v-show="curTab === 'upload'">
              <pso-upload visible dragable :upable="false" :srcable="false" :showconfirm="false" :headerable="false"></pso-upload>
            </div>
            ...
            <uphis v-show="curTab === 'uphis'"></uphis>
...
export default {
  ...
  methods: {
    ...
    async setSelect(data, tab = "upload") {
