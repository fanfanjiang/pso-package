      ...
      <template v-if="curNode && !initializing">
        ...
        <div class="pso-view-table" v-loading="saving">
          <template v-if="!!curNode.is_leaf">
            <div v-if="curTab === 'shit'">
              <el-form label-position="left" label-width="120px" size="small" style="margin-top:20px">
                <el-form-item label="数据源" required>
                  <el-input size="small" autocomplete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item label="范围字段" required>
                  <el-input size="small" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="同比规则" required>
                  <el-input size="small" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="环比规则" required>
                  <el-input size="small" autocomplete="off"></el-input>
                </el-form-item>
              </el-form>
            </div>
...
const TABS = [
  { label: "规则信息", id: "shit", icon: "el-icon-picture" },
