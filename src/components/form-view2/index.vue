        ...
        <div class="pso-formTable-header__right">
          ...
          <el-dropdown size="small" trigger="click" v-if="opChangable && !params.hideChangeBtn">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item v-for="(status, index) in statuses" :key="index" :disabled="!status.available">
                <el-popconfirm
          ...
          <el-dropdown size="small" trigger="click" v-if="opStageable">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item v-for="(stage, index) in stages" :key="index" :disabled="!stage.available">
                <el-popconfirm
