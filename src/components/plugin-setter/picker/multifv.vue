<template>
  <div class="pso-form">
    <el-button style="margin-bottom: 10px" size="small" type="primary" plain @click="addParam">添加表单配置</el-button>
    <div style="margin-bottom: 20px; background: #ecf5ff; padding: 20px" v-for="(d, i) in data" :key="i">
      <el-form label-position="top" size="mini">
        <picker-form from-text="选择表单" form-field="fid" source="3" :data="d" @loaded="formLoaded"></picker-form>
        ...
        <template v-if="d.cid !== 'pso-form-interpreter'">
          <el-button size="small" plain @click="setCurItem(i)">设置视图参数</el-button>
        </template>
...
const FIELDS = { fid: "", name: "", cid: "pso-form-view", opts: [] };
