  ...
  <div class="grid-designer" v-loading="initializing">
    <template v-if="!initializing">
      <div class="grid-designer__header">
        <div class="grid-designer__header-l"></div>
        <div class="grid-designer__header-r">
          <el-button size="mini" type="primary" plain @click="addModule">添加模块</el-button>
          <el-button size="mini" type="primary" plain @click="importModule">导入模块</el-button>
        </div>
      </div>
      <div class="grid-designer__body">
        ...
        <div class="grid-designer__panel"></div>
      </div>
    </template>
  </div>
</template>
