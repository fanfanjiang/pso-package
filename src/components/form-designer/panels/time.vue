<template>
  <div class="act-time-panel">
    <common-panel :cpnt="cpnt" :info="'可设为日期、时间或日期+时间'" :needPlaceholder="true" :needDefaultValue="false">
      ...
      <el-form-item label="默认值">
        <el-select size="small" v-model="cpnt.data._defaultType" placeholder="请选择">
          <el-option v-for="item in options[cpnt.data._type]" :key="item.value" :label="item.name" :value="item.value"></el-option>
        </el-select>
